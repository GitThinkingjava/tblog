...
//	
//	private  final String NEO4J_PORT="";
//	
//	private  final String NEO4J_ADDRESS="";
//	
...
//     */
//	public  <T> void getList(String cql, Set<T>... lists) {
//        //用于给每个Set list赋值
//        int listIndex = 0;
//        try {
...
//     * @return List<Map<String,Object>>
//     */
//    public  List<Map<String, Object>> getFields(String cql) {
