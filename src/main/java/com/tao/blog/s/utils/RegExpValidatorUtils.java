...
public class RegExpValidatorUtils {
	 ...
	 * @return
	 */
	public static boolean IsCheckPassword(String input) {
		// 可以包含数字、字母、下划线，并且要同时含有数字和字母，且长度要在8-16位之间。
		// ^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z_]{8,16}$
		// 6-20 位，字母、数字、字符
		String regStr = "^([A-Z]|[a-z]|[0-9]|[`~!@#$%^&*()+=|{}':;',\\\\[\\\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“'。，、？]){5,15}$";
		return match(regStr, input);
	}
	...
	public static void main(String[] args) {
		// 验证手机
		// boolean bool=IsHandset("18912345678");
		// 验证用户名
		// boolean bool=IsUserName("ZHANG123");
		// 验证密码
		boolean bool = IsCheckPassword("11111111");
		if (bool) {
			System.out.println("正确");
		} else {

			System.out.println("密码至少六位包含字符");
		}
	}
